            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (job.hasDescription) JobDetailDescriptionCard(description: job.description),

                  if (job.hasVoiceDescription)
                    JobDetailVoiceDescriptionCard(audioUrl: job.audioUrl!),

                  if (job.hasImage) JobDetailImagesCard(imageUrl: job.imageUrl!),

                  JobDetailInformationCard(job: job),

                  JobInvitationsSection(jobId: job.id),
