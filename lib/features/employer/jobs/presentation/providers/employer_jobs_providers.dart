...
final employerJobsRemoteDataSourceProvider =
    Provider<EmployerJobsRemoteDataSource>((ref) {
  return EmployerJobsRemoteDataSource(
    ref.read(apiClientProvider),
  );
});

final employerJobsRepositoryProvider =
    Provider<EmployerJobsRepository>((ref) {
  return EmployerJobsRepositoryImpl(
    ref.read(employerJobsRemoteDataSourceProvider),
  );
});
