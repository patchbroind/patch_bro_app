...
class EmployerInvitationsRepositoryImpl
    implements EmployerInvitationsRepository {
  EmployerInvitationsRepositoryImpl(
    this._remoteDataSource,
  );

  final EmployerInvitationsRemoteDataSource
      _remoteDataSource;
  ...
  Future<JobInvitationEntity> inviteWorker({
    ...
    final invitation =
        await _remoteDataSource.inviteWorker(
      jobId: jobId,
      workerId: workerId,
    );
